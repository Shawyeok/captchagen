...
function Captcha(options) {
  ...
  if (!this.options.height) this.options.height = constants.height;
  if (!this.options.width) this.options.width = constants.width;
  if (!this.options.text) this.options.text = generateText();
  if (!this.options.font) this.options.font = constants.font;
  if (!this.options.fontsize) this.options.fontsize = constants.fontsize;
  if (!this.options.lines) this.options.lines = constants.lines;
  if (!this.options.lineWidth) this.options.lineWidth = constants.lineWidth;
